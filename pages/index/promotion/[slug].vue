<template>
    <div>
        ...
        <div v-if="promotion" class="bg-white shadow-lg mt-4 p-10">
            <div class="">
                <h1 class="text-xl font-bold mt-10 text-center p-10 bg-blue-500 w-fit mx-auto text-white rounded-full">
                    {{
                        promotion?.title }}</h1>
            ...
            <section>
                ...
                <div v-if=" promotion.books &&  promotion.books.length>0" class="grid grid-cols-12 gap-x-4 gap-y-8 mt-10">
                    <BookCard v-for="book in promotion.books" :key="book.id" :book="book" class="col-span-3"/>
                </div>
                <div v-else>
